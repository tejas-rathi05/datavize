    ...
    >
      ...
      >
        <Button
          ...
          onClick={() => {
            // Open context sidebar for Posts menu
            if (label === "Posts" && contextSidebar) {
              contextSidebar.openContext("posts");
            }
          }}
        >
          <div className="w-full items-center flex justify-between">
            ...
            <div className="flex items-center gap-1">
              {/* Context sidebar toggle for Posts menu */}
              {label === "Posts" && (
        ...
        {submenus.map(({ href, label, active }, index) => (
          ...
          >
            <Link 
              href={href}
              onClick={() => {
                // Open context sidebar for Posts submenu items
                if (contextSidebar) {
                  contextSidebar.openContext("posts");
                }
              }}
